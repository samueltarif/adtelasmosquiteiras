  ...
  try {
    ...
    const attribution = {
      first_touch: {
        ...
        utm_content: lead.first_touch_utm_content || lead.utm_content,
        utm_term: lead.first_touch_utm_term || lead.utm_term,
        google_campaign_id: lead.first_touch_google_campaign_id || lead.google_campaign_id,
        google_adgroup_id: lead.first_touch_google_adgroup_id || lead.google_adgroup_id,
        google_creative_id: lead.first_touch_google_creative_id || lead.google_creative_id,
        google_match_type: lead.first_touch_google_match_type || lead.google_match_type,
        google_network: lead.first_touch_google_network || lead.google_network,
        google_device: lead.first_touch_google_device || lead.google_device,
        google_target_id: lead.first_touch_google_target_id || lead.google_target_id,
        gclid: lead.first_touch_gclid || lead.gclid,
        gbraid: lead.first_touch_gbraid || lead.gbraid,
        wbraid: lead.first_touch_wbraid || lead.wbraid
      },
      session_touch: {
        ...
        google_campaign_id: lead.google_campaign_id,
        google_adgroup_id: lead.google_adgroup_id,
        google_creative_id: lead.google_creative_id,
        google_match_type: lead.google_match_type,
        google_network: lead.google_network,
        google_device: lead.google_device,
        google_target_id: lead.google_target_id,
