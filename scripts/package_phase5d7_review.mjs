...
console.log('1. Verificando integridade física de todos os arquivos para o pacote da Fase 5.0D.7...')
...
const zipName = 'phase_5_0d7_delta_external_review.zip'
...
fs.writeFileSync('scripts/make_zip_temp_5d7.ps1', psScript)
execSync('powershell -ExecutionPolicy Bypass -File scripts/make_zip_temp_5d7.ps1')
try {
  fs.unlinkSync('scripts/make_zip_temp_5d7.ps1')
} catch (e) {
  // Ignore lock
}
...
console.log(`\n======================================================================`)
console.log(`FASE 5.0D.7 — FINAL EXTERNAL REVIEW PACKAGE GERADO COM SUCESSO!`)
