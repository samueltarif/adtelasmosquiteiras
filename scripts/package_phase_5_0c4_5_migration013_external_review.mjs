...
const zipPathDocs = 'docs/phase_5_0c4_5_migration013_external_review.zip'
const zipPathRoot = 'phase_5_0c4_5_migration013_external_review.zip'
const shaPathDocs = 'docs/phase_5_0c4_5_migration013_external_review.zip.sha256'
const shaPathRoot = 'phase_5_0c4_5_migration013_external_review.zip.sha256'
...
const tempPsFile = 'scripts/make_zip_temp_5c4_5.ps1'
...
console.log('\n3. Calculando e gerando arquivos sidecar SHA-256...')
...
fs.writeFileSync(shaPathRoot, `${zipSha256}  phase_5_0c4_5_migration013_external_review.zip\n`, 'utf8')
fs.writeFileSync(shaPathDocs, `${zipSha256}  phase_5_0c4_5_migration013_external_review.zip\n`, 'utf8')

console.log(`\n=================================================================`)
console.log(`PACOTE DE REVISÃO EXTERNA PATCH 5.0C.4.5 GERADO COM SUCESSO:`)
