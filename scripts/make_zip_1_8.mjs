...
const zipPathDocs = 'docs/admin_performance_patch_1_8_external_review.zip'
const zipPathRoot = 'admin_performance_patch_1_8_external_review.zip'
const shaPathDocs = 'docs/admin_performance_patch_1_8_external_review.zip.sha256'
const shaPathRoot = 'admin_performance_patch_1_8_external_review.zip.sha256'
...
fs.writeFileSync(shaPathDocs, `${sha256}  admin_performance_patch_1_8_external_review.zip\n`)
fs.writeFileSync(shaPathRoot, `${sha256}  admin_performance_patch_1_8_external_review.zip\n`)
...
const extractDir = 'scratch/review_zip_extracted_1_8'
