    ...
    <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto relative">
      ...
      <div class="flex items-center justify-between p-6 border-b border-gray-200">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h3 class="text-lg font-bold text-gray-900">Falar no WhatsApp</h3>
            <p class="text-sm text-gray-500">Preencha seus dados para continuar</p>
          </div>
        </div>
        <button 
          @click="closeModal"
      ...
      <form @submit.prevent="submitForm" class="p-6 space-y-4">
        ...
        <!-- Tipo de Serviço -->
        <div>
          <label for="tipoServico" class="block text-sm font-semibold text-gray-700 mb-2">
            Tipo de serviço *
          </label>
          <!-- Debug: mostrar valor atual -->
          <div v-if="formData.tipoServico" class="text-xs text-gray-500 mb-1">
            Selecionado: {{ formData.tipoServico }}
          </div>
          <select
            id="tipoServico"
            ...
            required
            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition-colors bg-white text-gray-900"
          >
            <option value="" class="text-gray-500">Selecione um serviço</option>
            <option value="Tela mosquiteira" class="text-gray-900">Tela mosquiteira</option>
