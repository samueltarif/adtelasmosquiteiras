...
const handleScroll = () => {
  // Mostrar CTAs sticky após rolar 300px
...
<template>
  <!-- Botão Orçamento Grátis - Inferior Esquerda Mobile -->
  <div 
    v-if="isVisible"
    class="fixed bottom-5 left-5 z-30 md:hidden animate-slide-up"
  >
    ...
    >
      ...
      <span class="font-extrabold">Orçamento</span>
    </a>
  </div>
</template>
