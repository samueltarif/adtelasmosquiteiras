<template>
  <div class="cta-container">
    ...
    >
      ...
      <span class="cta-text cta-text-mobile">Orçamento Grátis</span>
      <span class="cta-text cta-text-desktop">Orçamento</span>
    </a>
    ...
    >
      ...
      <span class="cta-text">Ligar Agora</span>
    </a>
  </div>
</template>
...
.cta-whatsapp:hover {
  background-color: #1fb854; /* 15% darker */
...
.cta-phone:hover {
  background-color: #0056cc; /* 15% darker */
  transform: translateY(-1px);
...
.cta-whatsapp:focus-visible {
  outline-color: rgba(37, 211, 102, 0.8);
}
