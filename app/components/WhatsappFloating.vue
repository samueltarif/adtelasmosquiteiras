...
<template>
  <a 
    ...
    class="fixed bottom-5 right-5 md:bottom-[30px] md:right-[30px] w-[60px] h-[60px] md:w-[70px] md:h-[70px] rounded-full flex items-center justify-center shadow-lg cursor-pointer z-[99] transition-all duration-300 hover:scale-[1.15] hover:-translate-y-1"
