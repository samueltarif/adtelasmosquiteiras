    ...
    <div class="block md:hidden">
      ...
      <div class="px-5 pt-5 pb-10">
        ...
        <a
          ...
          class="flex items-center justify-center gap-2.5 w-full h-14 bg-[#25D366] text-white rounded-2xl font-semibold text-base shadow-lg shadow-[#25D366]/25 active:scale-[0.98] transition-all mb-3"
        >
