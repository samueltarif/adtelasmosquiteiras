   ...
   <section id="telas-hero" class="hero" data-cta-location="hero" data-service-key="telas" data-service-name="Telas Mosquiteiras">
    ...
    <div class="wrap hero-inner"><div class="hero-copy">
     ...
     <div class="hero-bottom-block">
      <div class="hero-actions"><a :href="getWhatsappUrl('Telas Mosquiteiras')" class="button green" target="_blank" rel="noopener noreferrer"><WhatsappIcon /> <span>Pedir orçamento pelo WhatsApp <span aria-hidden="true">→</span></span></a><a href="#orcamento-telas" class="button secondary" @click.prevent="openQuoteForm"><Icon name="lucide:clipboard-list" /> <span>Receber orçamento pelo formulário</span></a></div>
