  ...
  <div class="min-h-screen bg-white">
    ...
    <section class="py-12 bg-white border-t border-[#E5EDF8]">
      <div class="container mx-auto px-4 md:px-6 max-w-4xl text-center">
        ...
        <a
          href="https://api.whatsapp.com/send/?phone=5511983586611&text=Ol%C3%A1%21%20Preciso%20de%20ajuda%20para%20escolher%20o%20servi%C3%A7o%20ideal.%20Vim%20pelo%20site%3A%20https%3A%2F%2Fwww.adtelasmosquiteiras.com.br&type=phone_number&app_absent=0"
          target="_blank"
