<script setup>
const bairro = 'Jardim das Vertentes'
const whatsappUrl = `https://wa.me/5511983586611?text=${encodeURIComponent(`Olá! Gostaria de um orçamento para ${bairro}. Vim pelo site: https://www.adtelasmosquiteiras.com.br/bairros/jardim-das-vertentes`)}`
